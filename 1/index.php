...
if (isset($_POST['rating'], $_POST['hear_about_us'], $_POST['contact_pref'], $_POST['email'], $_POST['comments'], $_POST['recommend'])) {
    ...
    $sql = "INSERT INTO `code`.`alpha` (`rating`, `hear_about_us`, `contact_pref`, `email`, `comments`, `recommend`) VALUES ('$rating', '$hear_about_us', '$contact_pref', '$email', '$comments', '$recommend');";
...
<body>
    <form class="survey-form" method="post" action="">
        <!-- responsible for the title of the form and define the elements for the 4 steps -->
